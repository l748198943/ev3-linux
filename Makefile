...
#GNU_ARM = c:/Programme.Portable/SourceryG++Lite/bin/arm-none-linux-gnueabi-
GNU_ARM = /cygdrive/c/Programme.Portable/SourceryG++Lite/bin/arm-none-linux-gnueabi-
...
all: $(BINDIR)/.f $(DEPDIR)/.f $(BINDIR)/$(APP_NAME)$(APP_EXT) DOWNLOAD

.PHONY : DOWNLOAD
DOWNLOAD:
	@echo "-> Downloading $(BINDIR)/$(APP_NAME) to $(EV3IP):$(EV3PATH)"
	$(SCP) $(BINDIR)/$(APP_NAME) root@$(EV3IP):$(EV3PATH)
